...
This is not meant to be fair, but also not so unfair its not fun (except extreme), create a suggestion [here]([https://github.com/archerv123456/minecraft-kaizo-editon-public/issues](https://kaizoedition.nhforums.net)) if you want to give a idea or if you want something to be more balenced.
